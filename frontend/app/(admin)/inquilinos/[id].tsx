...
export default function InquilinoDetailScreen() {
  ...
  const Section = ({ title, children }: any) => (
    <GlassCard style={styles.section} borderRadius={Theme.borderRadius.lg} border={true}>
  ...
  return (
    <View style={[styles.container, { backgroundColor: theme.background }]}>
      ...
      <ScrollView
        ...
        contentContainerStyle={{ paddingBottom: isDesktop ? 40 : insets.bottom + Theme.layout.dockHeight }}
      ...
      >
        <View style={[styles.headerCard, { backgroundColor: theme.card, borderColor: theme.border, paddingTop: isDesktop ? 24 : insets.top + 16 }]}>
          ...
          <View style={styles.profileSection}>
            <View style={[styles.avatarLarge, { backgroundColor: theme.primary, shadowColor: theme.primary }]}>
