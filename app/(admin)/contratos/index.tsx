  ...
  return (
    <View style={[styles.container, { backgroundColor: theme.background }]}>
      ...
      <View style={[styles.header, isDesktop && styles.headerDesktop, !isDesktop && { paddingTop: insets.top + 20 }]}>
        ...
        <GlassCard intensity={30} borderRadius={16} style={styles.searchContainer} border={false}>
...
const styles = StyleSheet.create({
  ...
  cardMeta: { fontSize: 13, fontWeight: '500', opacity: 0.85 },
  dot: { fontSize: 12 },
  generateBtn: {
    flexDirection: 'row', alignItems: 'center', gap: 6,
    paddingHorizontal: 14, paddingVertical: 10, borderRadius: 12, flexShrink: 0,
  },
