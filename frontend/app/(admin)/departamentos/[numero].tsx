...
export default function DepartamentoDetailScreen() {
  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: theme.background }]} contentContainerStyle={{ paddingBottom: isDesktop ? 32 : insets.bottom + Theme.layout.dockHeight }}>
