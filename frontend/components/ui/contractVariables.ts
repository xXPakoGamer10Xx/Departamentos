...
<p><strong>11.-</strong> Compensación no reembolsable. La cantidad entregada por concepto de compensación no será devuelta al arrendatario bajo ninguna circunstancia, sea cual sea la causa de terminación del contrato (vencimiento natural, desocupación anticipada o incumplimiento). Dicha cantidad es adicional e independiente de la renta mensual, no tiene el carácter de depósito en garantía ni de fondo para mantenimiento, pintura o restauración del inmueble, y tampoco podrá aplicarse como pago de mensualidades de renta. Cualquier daño, deterioro o reparación imputable al arrendatario será cubierto por éste de manera adicional y por separado, conforme a lo dispuesto en la cláusula sexta de este contrato.</p>
...
export const CONTRACT_VARS: ContractVar[] = [
  ...
  { key: 'arrendatario_linea',  label: 'Línea arrendatario' },
  { key: 'arrendador_linea',    label: 'Línea arrendadora' },
  { key: 'fiador_linea',        label: 'Línea fiador' },
];
