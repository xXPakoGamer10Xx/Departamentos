...
<p>El arrendatario entregará un depósito en garantía de <strong>{{deposito}}</strong>, pagadero en {{metodo_pago}} al inicio del presente contrato.</p>
