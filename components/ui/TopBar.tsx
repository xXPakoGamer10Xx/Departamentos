      ...
      <View style={[styles.container, { borderBottomColor: isDark ? 'rgba(255,255,255,0.06)' : 'rgba(0,0,0,0.05)' }]}>
        ...
        <View style={styles.content}>
          <View style={styles.searchWrapper}>
            <View style={[
              styles.searchBox,
              {
                ...
                borderColor: showResults ? theme.primary : (isDark ? 'rgba(255,255,255,0.05)' : 'transparent'),
                borderWidth: 1,
              }
            ]}>
              {loadingSearch
            ...
            {showResults && (
              <View style={[
                ...
                { backgroundColor: isDark ? '#1c1c1e' : '#ffffff', borderColor: isDark ? 'rgba(255,255,255,0.08)' : 'rgba(0,0,0,0.08)' }
              ]}>
                {searchResults.length === 0 && !loadingSearch ? (
                  ...
                  searchResults.map(item => (
                    <TouchableOpacity
                      ...
                      style={[styles.searchResultRow, { borderBottomColor: isDark ? 'rgba(255,255,255,0.05)' : 'rgba(0,0,0,0.05)' }]}
                      onPress={() => {
                        setSearchQuery('');
                        setShowResults(false);
                    ...
                    >
                      <View style={[
                        ...
                        { backgroundColor: item.type === 'inquilino' ? '#FF950015' : '#34C75915' }
                      ]}>
                        <Ionicons
                          name={item.type === 'inquilino' ? 'person' : 'business'}
                          size={15}
                          color={item.type === 'inquilino' ? '#FF9500' : '#34C759'}
                        />
                      </View>
                      <View style={{ flex: 1 }}>
          ...
          <View style={styles.actions}>
            <TouchableOpacity
              style={[styles.actionBtn, { backgroundColor: isDark ? 'rgba(255,255,255,0.03)' : 'transparent' }]}
              onPress={openNotifications}
            >
              <Ionicons name="notifications-outline" size={22} color={theme.text} />
              {totalUrgentes > 0 && (
                <View style={[styles.badge, { borderColor: isDark ? '#1a1a1a' : '#fff' }]}>
                  {totalUrgentes > 1 && (
