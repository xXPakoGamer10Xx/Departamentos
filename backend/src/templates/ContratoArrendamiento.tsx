...
export function ContratoArrendamiento({ data }: ContratoProps) {
  ...
  const clauses = [
    ...
    `Compensación no reembolsable. Las partes convienen que la cantidad entregada por concepto de compensación es adicional e independiente de la renta mensual. Dicha cantidad no tiene el carácter de depósito en garantía ni de fondo para mantenimiento, pintura o restauración del inmueble, y en ningún caso, ya sea al vencimiento natural del contrato, por desocupación anticipada o por incumplimiento del arrendatario, existirá devolución de dicha cantidad, ni podrá aplicarse como pago de mensualidades de renta. Cualquier daño, deterioro o reparación imputable al arrendatario será cubierto por éste de manera adicional y por separado, conforme a lo dispuesto en la cláusula sexta de este contrato.`,
