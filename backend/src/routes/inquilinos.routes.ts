...
import { authMiddleware, adminOnly, requirePermiso, pdfAuth } from '../middleware/auth.middleware';
...
inquilinosRouter.get('/:id/pdf', pdfAuth, getContratoPdf);

inquilinosRouter.use(authMiddleware);

inquilinosRouter.post('/:id/pdf-token', requirePermiso('contratos'), generarTokenPdf);

// Editor de contrato por inquilino
inquilinosRouter.get('/:id/contrato-editable', requirePermiso('contratos'), getContratoEditable);
inquilinosRouter.put('/:id/contrato', requirePermiso('contratos'), auditLog('inquilinos', 'editar'), guardarContratoInquilino);
inquilinosRouter.post('/:id/contrato-preview', requirePermiso('contratos'), previewContratoInquilino);
...
inquilinosRouter.delete('/:id', requirePermiso('inquilinos.editar'), auditLog('inquilinos', 'eliminar'), deleteInquilino);
